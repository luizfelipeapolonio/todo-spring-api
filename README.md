...
- Ver informações do usuário autenticado.
  <details>
    ...
    <br />
    <img src="./assets/AuthUserInfo_Todo_Spring_API.png" height="480px" alt="Imagem mostrando as informações do usuário autenticado" />
  </details>
...
- Excluir usuário e todas suas tarefas.
  <details>
    <summary>Clique aqui para ver a imagem</summary>
    <br />
    <img src="./assets/DeleteUser_Todo_Spring_API.png" height="480px" alt="Imagem mostrando a deleção de usuário" />
  </details>
...
- Criar tarefa.
  <details>
    <summary>Clique aqui para ver a imagem</summary>
    <br />
    <img src="./assets/CreateTask_Todo_Spring_API.png" height="480px" alt="Imagem demonstrando a criação de uma tarefa" />
  </details>
...
- Atualizar tarefa.
  <details>
    <summary>Clique aqui para ver a imagem</summary>
    <br />
    <img src="./assets/UpdateTask_Todo_Spring_API.png" height="480px" alt="Imagem mostrando atualização de tarefa" />
  </details>
...
- Excluir tarefa.
  <details>
    <summary>Clique aqui para ver a imagem</summary>
    <br />
    <img src="./assets/DeleteTask_Todo_Spring_API.png" height="480px" alt="Imagem mostrando a deleção de tarefa" />
  </details>
...
- Listar todas as tarefas do usuário.
  <details>
    <summary>Clique aqui para ver a imagem</summary>
    <br />
    <img src="./assets/AllUserTasks_Todo_Spring_API.png" height="480px" alt="Imagem mostrando todas as tarefas do usuário" />
  </details>
...
- Ver tarefa específica.
  <details>
    <summary>Clique aqui para ver a imagem</summary>
    <br />
    <img src="./assets/GetTask_Todo_Spring_API.png" height="480px" alt="Imagem mostrando tarefa específica" />
  </details>
...
- Listar todas as tarefas marcadas como feitas.
  <details>
    <summary>Clique aqui para ver a imagem</summary>
    <br />
    <img src="./assets/GetDoneTasks_Todo_Spring_API.png" height="480px" alt="Imagem mostrando todas as tarefas marcadas como feita" />
  </details>
...
- Algumas das respostas de erro que a API retorna.
  <details>
    <summary>Clique aqui para ver as imagens</summary>
    <br />
    <img src="./assets/Error1_Todo_Spring_API.png" height="480px" alt="Imagem mostrando uma resposta de erro" />
    <img src="./assets/Error2_Todo_Spring_API.png" height="480px" alt="Imagem mostrando uma resposta de erro" />
    <img src="./assets/Error3_Todo_Spring_API.png" height="480px" alt="Imagem mostrando uma resposta de erro" />
    <img src="./assets/Error4_Todo_Spring_API.png" height="480px" alt="Imagem mostrando uma resposta de erro" />
  </details>
